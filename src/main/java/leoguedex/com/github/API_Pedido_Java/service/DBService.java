...
import leoguedex.com.github.API_Pedido_Java.domain.entity.*;
...
import leoguedex.com.github.API_Pedido_Java.domain.repository.*;
...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException{
        ...
        est2.getCidades().addAll(Arrays.asList(cid3, cid3));

        estadoRepository.saveAll(Arrays.asList(est1, est2));
        cidadeRepository.saveAll(Arrays.asList(cid1, cid2, cid3));

        Cliente cli1 = new Cliente(null, "Maria Silva", "leo.guedes.correa@gmail.com", "36378912377",
        ...
        Pedido ped2 = new Pedido(null, sdf.parse("10/12/2017 19:35"), cli1, e2);
